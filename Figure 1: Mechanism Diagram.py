...
OUTPUT_DIR = r"/Users/MaJun/PycharmProjects/Python(Ajou University)/The Stability Trap Hypothesis/提交代码/Figure 1: Mechanism Diagram"
...
def main():
    ...
    png_path = os.path.join(OUTPUT_DIR, "Figure_1.png")
    svg_path = os.path.join(OUTPUT_DIR, "Figure_1.svg")

    mpl.rcParams['savefig.bbox'] = 'standard'
    mpl.rcParams['savefig.pad_inches'] = 0.05

    fig.savefig(png_path, dpi=1000, pil_kwargs={"dpi": (1000, 1000)})
