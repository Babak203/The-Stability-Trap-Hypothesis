...
DATA_PATH = Path(
    "/Users/MaJun/PycharmProjects/Python(Ajou University)/The Stability Trap Hypothesis/提交代码/Figure 6: COVID-19 event-driven impact/covid_event_study_coeffs.csv"
)
...
OUTPUT_FIG = OUTPUT_DIR / "Figure 6: COVID-19 event-driven impact.png"
...
def main() -> None:
    ...
    fig.savefig(str(base) + ".svg", dpi=1000)
